...
$r = Get-AzResource -ResourceGroupName $ResGrpName -ResourceType $ResourceType/config -Name $ResourceName/web -ApiVersion 2016-08-01
...
Set-AzResource -Force -ResourceGroupName  $ResGrpName -ResourceType $ResourceType/config -Name $ResourceName/web -PropertyObject $properties -ApiVersion 2016-08-01
